...
const sortByChildren = (charArray) => {
  return charArray.sort((fewest, most) => {
    if (fewest.children > most.children) { return 1; }
    else if
      (fewest.children < most.children) { return -1; }
    else {
      if (fewest.name > most.name) { return 1; }
      else if (fewest.name < most.name) { return -1; }
    }
  });
};
